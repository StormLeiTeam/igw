...
public class CommonViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener, View.OnClickListener {
    ...
    public CommonViewHolder setViewSelected(int viewId, boolean isSelected) {
    ...
    public interface onItemCommonClickListener {
        ...
        void onItemClickListener(View view, Object o, int position);

        void onItemLongClickListener(View view, Object o, int position);
    }
    ...
    public void onClick(View v) {
        if (commonClickListener != null) {
            commonClickListener.onItemClickListener(v, null, getAdapterPosition());
        }
    }
    ...
    public boolean onLongClick(View v) {
        if (commonClickListener != null) {
            commonClickListener.onItemLongClickListener(v, null, getAdapterPosition());
        }
        return false;
    }
}
