...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = IGWApplication.getContext()
                    .getPackageManager()
                    .getPackageInfo(IGWApplication.getContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && IGWApplication.getContext().getExternalCacheDir() != null)
                mDefaultDir = IGWApplication.getContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = IGWApplication.getContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
