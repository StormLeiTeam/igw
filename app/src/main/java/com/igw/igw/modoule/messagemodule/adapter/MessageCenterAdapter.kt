    ...
    override fun onBindViewHolder(holder: RvViewHolder, position: Int) {
        ...
        when (itemViewType) {
            ...
            1 -> {
                ...
                var imagePath = mDatas?.get(position)?.headImage

                GlideUtils.loadImage(mContext, Constants.BASE_URL + imagePath, headImg)
...
//                var imagePath = mDatas?.get(position)?.headImage
                ...
                GlideUtils.loadImage(mContext, R.drawable.news, headerView)
